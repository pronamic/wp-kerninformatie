...
Tags: pronamic, kerninformatie
Donate link: http://pronamic.eu/donate/?for=wp-plugin-kerninformatie&source=wp-plugin-readme-txt
Requires at least: 3.0
Tested up to: 3.4.1
Stable tag: 0.1

The WordPress Kerninformatie plugin can display answers from the Kerninformatie application.
